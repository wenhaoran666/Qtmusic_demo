...
QT_MOC_LITERAL(1, 14, 10), // "listchange"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16), // "QList<MusicInfo>"
QT_MOC_LITERAL(4, 43, 8), // "newSongs"
QT_MOC_LITERAL(5, 52, 9), // "nowchange"
QT_MOC_LITERAL(6, 62, 14) // "m_currentIndex"

    },
    "PlaylistModel\0listchange\0\0QList<MusicInfo>\0"
    "newSongs\0nowchange\0m_currentIndex"
};
...
void PlaylistModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->listchange((*reinterpret_cast< const QList<MusicInfo>(*)>(_a[1]))); break;
        case 1: _t->nowchange((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (PlaylistModel::*)(const QList<MusicInfo> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlaylistModel::listchange)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlaylistModel::nowchange)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PlaylistModel::listchange(const QList<MusicInfo> & _t1)
{
...
// SIGNAL 1
void PlaylistModel::nowchange(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
